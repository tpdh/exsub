(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["chunk-1ffacd5c"], {
        ...
        {
            var n = o("c6b6"),
                l = o("9263");e.exports = function(e, t)
        ...
        {
            "use strict";
            var n = o("6547").charAt;e.exports = function(e, t, o)
        ...
        {
            "use strict";
            var n = o("d039");e.exports = function(e, t)
...

        {
            ...
            c = "clash",
            u = "https://v1.mk/short",
            f = "https://api.v1.mk/config/upload",
            p = "https://t.me/JesusFuckingFree",
            m = {
                data: function()
                ...
                methods: {
...

                    {
                        ...
                        !1;
                        var e = "clash://install-config?url=";window.open(e + encodeURIComponent("" !== this.curtomShortSubUrl ? this.curtomShortSubUrl : this.customSubUrl))
                    },
...

                    {
                        if ("" === this.customSubUrl) return this.$message.error("请先填写必填项，生成订阅链接"),
                        !1;
                        var e = "surge://install-config?url=";window.open(e + this.customSubUrl)
                    },
                    makeUrl: function()

                    {
                        ...
                        var t = "" === this.form.customBackend ? s : this.form.customBackend,
                            o = "null" === this.form.remoteConfig ? "" : this.form.remoteConfig,
                        ...
                        !1;this.customSubUrl = t + "target=" + this.form.clientType + "&url=" + encodeURIComponent(n) + "&insert=" + this.form.insert,
    ...
    // 处理 emoji、nodeList、udp、tfo、scv、fdn 和 sort
    !0 === this.form.emoji && (this.customSubUrl += "&emoji=" + this.form.emoji.toString()),
    !0 === this.form.nodeList && (this.customSubUrl += "&list=" + this.form.nodeList.toString()),
    !0 === this.form.udp && (this.customSubUrl += "&udp=" + this.form.udp.toString()),
    !0 === this.form.tfo && (this.customSubUrl += "&tfo=" + this.form.tfo.toString()),
    !0 === this.form.scv && (this.customSubUrl += "&scv=" + this.form.scv.toString()),
    !0 === this.form.fdn && (this.customSubUrl += "&fdn=" + this.form.fdn.toString()),
    !0 === this.form.sort && (this.customSubUrl += "&sort=" + this.form.sort.toString()),
    ...
    "clash" === this.form.clientType && (
        ...
        this.customSubUrl += "&new_name=" + this.form.new_name.toString()
...

                    {
                        ...
                        !1;
                        var t = "" === this.form.shortType ? c : this.form.shortType;this.loading = !0;
                        var o = new FormData;o.append("longUrl", btoa(this.customSubUrl)),
                        this.$axios.post(t, o, {
                            header: {
...

                    {
                        ...
                        !1;this.loading = !0;
                        var t = new FormData;t.append("password", this.uploadPassword),
...

                    {
                        var o = this.options.backendOptions,
                            n = e ? o.filter(this.createFilter(e)) : o;t(n)
                    },
                    ...
                    {
                        var e = this;this.$axios.get(s.substring(0, s.length - 5) + "/version").then((function(t)
            ...
            d = m,
            h = o("2877"),
            b = Object(h["a"])(d, n, l, !1, null, null, null);t["default"] = b.exports
        },
        ac1f: function(e, t, o)
        ...
        {
            "use strict";
            var n = o("825a");e.exports = function()
